...
namespace emperor_mvc.Controllers
{
    public class PDFController : Controller
    {
        ...
        public IActionResult MianshaContinues(PDFModel model)
        {
            model.link = "https://highchurch.space/Documents/MianshaContinues.pdf";
            model.set_html();
            return View("Index", model);
        }

        public IActionResult BadApples(PDFModel model)
        {
            model.link = "https://highchurch.space/Documents/BadApples.pdf";
            model.set_html();
            return View("Index", model);
        }
